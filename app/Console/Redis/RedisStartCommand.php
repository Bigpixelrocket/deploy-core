...
namespace DeployCore\Console\Redis;
...
class RedisStartCommand extends BaseCommand
{
    use PlaybooksTrait;
    use ServersTrait;
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (is_int($result)) {
            $this->nay('Failed to start Redis service');

            return Command::FAILURE;
        }

        $this->yay('Redis service started');
