...
class MemcachedStartCommand extends BaseCommand
{
    use PlaybooksTrait;
    use ServersTrait;
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->h1('Start Memcached Service');
        ...
        if (is_int($result)) {
            $this->nay('Failed to start Memcached service');

            return Command::FAILURE;
        }

        $this->yay('Memcached service started');
